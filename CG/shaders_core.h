#ifndef A_SHADERS_CORE_H
#define A_SHADERS_CORE_H
...
"					{\n"
"						float r = (t+(-mparams[0].y))/mparams[0].w;\n"
"						acc.rgb = texture(sampler3, r).rgb;\n"
"						acc.a   = 1.0;\n"
"						t0 = t;\n"
"					}\n"
"				}\n"
...
const char mip_color_fs_bb_sigm[] =
"#version 150\n"
"uniform sampler2D sampler0;\n"
"uniform sampler2D sampler1;\n"
"uniform sampler3D sampler2;\n"
