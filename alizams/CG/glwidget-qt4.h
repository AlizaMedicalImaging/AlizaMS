...
public:
	...
	GLuint raycast_shader_vbo1;
	GLuint raycast_shader_vbo2;
	GLuint raycast_color_shader_vbo0;
	GLuint raycast_color_shader_vbo1;
	GLuint raycast_color_shader_vbo2;
	GLuint raycast_shader_bb_vbo0;
	GLuint raycast_shader_bb_vbo1;
	GLuint raycast_shader_bb_vbo2;
	GLuint raycast_color_shader_bb_vbo0;
	GLuint raycast_color_shader_bb_vbo1;
	GLuint raycast_color_shader_bb_vbo2;
	GLuint raycast_shader_sigm_vbo0;
	GLuint raycast_shader_sigm_vbo1;
	GLuint raycast_shader_sigm_vbo2;
	GLuint raycast_color_shader_sigm_vbo0;
	GLuint raycast_color_shader_sigm_vbo1;
	GLuint raycast_color_shader_sigm_vbo2;
	GLuint raycast_shader_bb_sigm_vbo0;
	GLuint raycast_shader_bb_sigm_vbo1;
	GLuint raycast_shader_bb_sigm_vbo2;
	GLuint raycast_color_shader_bb_sigm_vbo0;
	GLuint raycast_color_shader_bb_sigm_vbo1;
	GLuint raycast_color_shader_bb_sigm_vbo2;
	...
	void generate_raycastcube1_vao(GLuint*, GLuint*, GLuint*, GLuint*);
	void generate_raycastcube2_vao(GLuint*, GLuint*, GLuint*, GLuint*);
	void generate_raycast_shader_vao(GLuint*, GLuint*, GLuint*, GLuint*, GLuint*);
	bool update_raycast_shader_vbo( unsigned int,
		float, float, float,
		GLuint*, GLuint*, GLuint*,
		bool);
	void raycast_cube(float, float, float, GLuint*, GLuint*, GLuint*,bool);
  	void raycast_cube_RIP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LIP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RSP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LSP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RIA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LIA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RSA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LSA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IRP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ILP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SRP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SLP(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IRA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ILA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SRA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SLA(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RPI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LPI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RAI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LAI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RPS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LPS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_RAS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_LAS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PRI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PLI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ARI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ALI(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PRS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PLS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ARS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ALS(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IPR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SPR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IAR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SAR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IPL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SPL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_IAL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_SAL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PIR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PSR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_AIR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_ASR(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PIL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_PSL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
	void raycast_cube_AIL(float, float, float, GLuint*, GLuint*, GLuint*,bool);
