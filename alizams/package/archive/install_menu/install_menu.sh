...
if [ ! -d "${HOME}/.local" ];
  then mkdir "${HOME}/.local";
fi
if [ ! -d "${HOME}/.local/share" ];
  then mkdir "${HOME}/.local/share";
fi
if [ ! -d "${HOME}/.local/share/applications" ];
  then mkdir "${HOME}/.local/share/applications";
fi
if [ ! -d "${HOME}/.local/share/icons" ];
  then mkdir "${HOME}/.local/share/icons";
fi
if [ ! -d "${ALIZAMS_I_DIR}" ];
  then mkdir "${ALIZAMS_I_DIR}";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/16x16/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/16x16/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/22x22/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/22x22/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/24x24/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/24x24/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/32x32/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/32x32/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/36x36/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/36x36/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/42x42/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/42x42/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/48x48/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/48x48/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/64x64/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/64x64/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/72x72/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/72x72/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/96x96/apps" ];
  then mkdir -p "${ALIZAMS_I_DIR}/96x96/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/128x128/apps" ];
then mkdir -p "${ALIZAMS_I_DIR}/128x128/apps";
fi
if [ ! -d "${HOME}/.local/share/icons/hicolor/192x192/apps" ];
...
if [ ! -d "${HOME}/.local/share/icons/hicolor/scalable/apps" ];
