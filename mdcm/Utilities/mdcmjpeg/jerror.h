...
JMESSAGE(JERR_BAD_LOSSLESS, "Invalid lossless parameters Ss=%d Se=%d Ah=%d Al=%d")
JMESSAGE(JERR_BAD_LOSSLESS_SCRIPT, "Invalid lossless parameters at scan script entry %d")
...
JMESSAGE(JERR_CANT_TRANSCODE, "Cannot transcode to/from lossless JPEG datastreams")
...
JMESSAGE(JMSG_COPYRIGHT, JCOPYRIGHT) JMESSAGE(JMSG_VERSION, JVERSION)
...
JMESSAGE(JTRC_UNKNOWN_LOSSLESS_IDS, "Unrecognized component IDs %d %d %d, assuming RGB")
JMESSAGE(JTRC_UNKNOWN_LOSSY_IDS, "Unrecognized component IDs %d %d %d, assuming YCbCr")
...
JMESSAGE(JWRN_MUST_DOWNSCALE, "Must downscale data from %d bits to %d")
