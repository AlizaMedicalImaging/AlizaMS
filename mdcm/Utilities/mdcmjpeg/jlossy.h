...
typedef struct
{
  ...
  /* Entropy encoding */
  JMETHOD(boolean, entropy_encode_mcu, (j_compress_ptr cinfo, JBLOCKROW * MCU_data));
...
typedef struct
{
  ...
  JMETHOD(boolean, entropy_decode_mcu, (j_decompress_ptr cinfo, JBLOCKROW * MCU_data));
