...
#  define CONST_BITS 14
        ...
        for (i = 0; i < DCTSIZE2; i++)
        {
          ifmtbl[i] = (IFAST_MULT_TYPE)DESCALE(MULTIPLY16V16((IJG_INT)qtbl->quantval[i], (IJG_INT)aanscales[i]),
...
jinit_inverse_dct(j_decompress_ptr cinfo)
{
  ...
  idct = (idct_ptr)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE, SIZEOF(idct_controller));
