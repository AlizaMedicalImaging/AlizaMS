...
unsigned long
SurfaceWriter::GetNumberOfSurfaces()
{
...
void
SurfaceWriter::SetNumberOfSurfaces(const unsigned long nb)
{
  NumberOfSurfaces = nb;
}

bool
SurfaceWriter::PrepareWrite()
{
  ...
  for (; it0 != it0End; ++it0)
  {
    ...
    for (; it1 != it1End; ++it1)
    {
      ...
      if (numberofvectors > 0 && primitiveType != MeshPrimitive::TRIANGLE_STRIP &&
...
bool
SurfaceWriter::PrepareWritePointMacro(SmartPointer<Surface> surface, DataSet & surfaceDS, const TransferSyntax & ts)
{
  /* Surface Points  */
  // (0066,0011) SQ (Sequence with undefined length #=1) # u/l, 1 Surface Points Sequence
  //   (fffe,e000) na (Item with undefined length #=1)   # u/l, 1 Item
