...
public:
  ...
  static STATES GetSTATES(const char *);
  ...
  void SetCenterOfRotation(const float *);
  unsigned long GetNumberOfVectors() const;
  void SetNumberOfVectors(const unsigned long);
  unsigned short GetVectorDimensionality() const;
  void SetVectorDimensionality(const unsigned short);
  ...
  void SetVectorCoordinateData(DataElement const &);
  MeshPrimitive const & GetMeshPrimitive() const;
  MeshPrimitive & GetMeshPrimitive();
  void SetMeshPrimitive(MeshPrimitive &);
private:
