...
// CID 7202 Source Image Purposes of Reference
const CodeDefinition SourceImagePurposesofReference[] = {
{"DCM",121320,"Uncompressed predecessor"},
{"DCM",121321,"Mask image for image processing operation"},
{"DCM",121322,"Source image for image processing operation"},
{"DCM",121329,"Source image for montage"},
...
// CID 7203 Image Derivation
const CodeDefinition ImageDerivation[] = {
{ "DCM",113040,"Lossy Compression" },
{ "DCM",113041,"Apparent Diffusion Coefficient" },
{ "DCM",113042,"Pixel by pixel addition" },
{ "DCM",113043,"Diffusion weighted" },
...
const CodeDefinition PurposeOfReferencetoAlternateRepresentation[] = {
...
{
public:
  FileDerivationInternals() : 
    References(),
    DerivationCodeSequenceCodeValue(0),
    PurposeOfReferenceCodeSequenceCodeValue(0),
...
FileDerivation::FileDerivation() :
  F(new File),
  Internals(new FileDerivationInternals)
{
}
...
bool FileDerivation::AddSourceImageSequence()
{
  ...
  {
    mdcmWarningMacro("Do not support appending Referenced Image");
    return false;
  }
...
bool FileDerivation::Derive()
{
  ...
  if(!b)
  {
    mdcmDebugMacro("Could not AddSourceImageSequence");
    return false;
  }
  b = AddDerivationDescription();
  if(!b)
  {
    mdcmDebugMacro("Could not AddDerivationDescription");
    return false;
  }
  return true;
}
