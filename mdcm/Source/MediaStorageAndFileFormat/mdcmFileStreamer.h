...
=========================================================================*/
#ifndef MDCMFILESTREAMER_H
#define MDCMFILESTREAMER_H
 ...
 * DataElement to add.
 */
class MDCM_EXPORT FileStreamer : public Subject
{
public:
  FileStreamer();
  ~FileStreamer();
  ...
  // Instead of simply blindly copying the input DICOM Template file, MDCM will
  ...
  // This will compute the proper attribute length.
