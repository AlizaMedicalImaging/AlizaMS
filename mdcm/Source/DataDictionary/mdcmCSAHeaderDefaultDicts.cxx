...
// $ xsltproc CSADefaultDicts.xsl CSAHeader.xml > mdcmCSAHeaderDefaultDicts.cxx
...
#ifndef MDCMCSAHEADERDEFAULTDICT_CXX
#define MDCMCSAHEADERDEFAULTDICT_CXX
...
static const CSA_DICT_ENTRY CSAHeaderDataDict[] = {
  { "AcquisitionDate",
    ...
    VR::DA,
    VM::VM1,
    "A number identifying the single continuous gathering of data over a period of time which resulted in this image" },
  { "ContentDate",
    "2C",
    VR::DA,
    VM::VM1,
    "The date the image data creation started. Required if image is part of a series in which the images are "
    "temporally related" },
  ...
  { "ContentTime",
    ...
    VR::TM,
    VM::VM1,
    "The time the image pixrl data creation started. Required if image is part of a series in which the images are "
    "temporally related" },
  { "Acquisition Datetime",
    "3",
    VR::DT,
    VM::VM1,
    "The date and time that the acquisition of dada that result in this image started" },
  ...
  { "> Referenced Frame Number",
    ...
    VR::IS,
    VM::VM1_n,
    "References one or more image frames of a Multi-frame Image SOP Instance, identifying which frames are "
    "siginificantly related to this image" },
  //{">Referenced SOP Class UID","1C",VR::UI,VM::VM1,"Uniquely identifies the referenced SOP Class"},
  //{">Referenced SOP Instance UID","1C",VR::UI,VM::VM1,"Uniquely identifies the referenced SOP Instance"},
  //{"> Referenced Frame Number","3",VR::IS,VM::VM1_n,"References one or more image frames of a Multi-frame Image SOP
  //Instance, identifying which frames are siginificantly related to this image"},
  { "ImageType", "3", VR::CS, VM::VM1_n, "Image identification characteristics" },
  { "Lossy Image Compression",
    "3",
    VR::CS,
    VM::VM1,
    "Specifies whether an image has undergone lossy compression. Enumerated values: 00 = image has not been subjected "
    "to lossy compression. 01 = image has been subjected to lossy compression" },
  { "Quality Control Image",
    "1C",
    VR::CS,
    VM::VM1,
    "Indicates whether or not this image is a quality control or phantom image. Enumerated values: YES, NO" },
  { "PatientOrientation",
    "2",
    VR::CS,
    VM::VM1,
    "Patient direction of the rows and columns of the image. Not required for MR images" },
  ...
  { "Scanning Sequence",
    ...
    VR::CS,
    VM::VM1_n,
    "Description of the type of data taken. Enumerated values: SE = Spin Echo; IR = Inversion Recovery; GR = Gradient "
  ...
  { "MRAcquisitionType",
    ...
    VR::CS,
    VM::VM1,
    "Identification of date encoding scheme. Enumerated Values: 2D = frequency x phase 3D = frequency x phase x "
    "phase" },
  { "SequenceName",
    "3",
    VR::SH,
    VM::VM1,
    "User defined name for the Scanning Sequence and Sequence Varaint combination" },
  { "AngioFlag",
    "3",
    VR::CS,
    VM::VM1,
  ...
  { "RepetitionTime",
    ...
    VR::DS,
    VM::VM1,
    "The period of time in msec between the beginning of a pulse sequence and the beginning of a succeeding "
    "(essentially identical) pulse sequence. Required except when Scanning Sequence is EP and Sequnece Variant is not "
    "segmented k-space" },
  { "EchoTime",
    "2",
    VR::DS,
    VM::VM1,
    "Time in msec between the middle of the excitation pulse and the peak of the echo produced. In the case of "
    "segmented k-space, the TE(eff) is the time between the middle of the excitation pulse to the peak of the echo "
    "that is used to cover the center of k-space)" },
  { "InversionTime",
    "2C",
    VR::DS,
    VM::VM1,
    "Time in msec after the middle of inverting RF pulse to middle of excitation pulse to detect the amount of "
    "longitudinal magnetization. Required if Scanning Sequence has value of IR" },
  { "NumberOfAverages",
    "3",
    VR::DS,
    VM::VM1,
    "Number of times a given pulse sequence is repeated before any parameter has changed" },
  ...
  { "NumberOfPhaseEncodingSteps",
    ...
    VR::IS,
    VM::VM1,
    "Total number of lines in k-space in the y-direction collecting during acquisition" },
  ...
  { "PercentPhaseFieldOfView",
    ...
    VR::DS,
    VM::VM1,
    "Ration of field of view dimension in phase direction to field of view dimension in frequency direction, expressed "
    "as a percent" },
  ...
  { "TriggerTime",
    ...
    VR::DS,
    VM::VM1,
    "Time, in msec, between peak of the R wave and the peak of the echo produced. In the case of segmented k-space, "
    "the TE(eff) is the time between the peak of the echo that is used to cover the center of k-space. Required for "
    "Scan Options which include heart gating" },
  ...
  { "TriggerWindow",
    ...
    VR::IS,
    VM::VM1,
    "Percent of R-R interval, based on Heart Rate (0018,1088), prescriped as a window for a valid/usable trigger" },
  { "ReconstructionDiameter",
    "3",
    VR::DS,
    VM::VM1,
    "Diameter in mm of the region from within which data were used in creating the reconstruction of the image. Data "
    "may exist outside this region and portions of the patient may exist outside the region" },
  ...
  { "AcquisitionMatrix",
    ...
    VR::US,
    VM::VM4,
    "Dimension of acquired frequency/phase data before reconstruction. Multi-valued: frequency rows/frequency "
    "columns/phase rows/phase columns" },
  { "PhaseEncodingDirection",
    "3",
    VR::CS,
    VM::VM1,
    "The axis of phase encoding with respect to the image. Enumerated Values: ROW = phase encoded in rows COL = phase "
    "encoded in columns" },
  { "FlipAngle",
    "3",
    VR::DS,
    VM::VM1,
    "Steady state angle in degrees to which the magnetic vector is flipped from the magnetic vector to the primary "
    "field" },
  { "VariableFlipAngleFlag",
    "3",
    VR::CS,
    VM::VM1,
    "Flip angle variation applied during image acquisition. Enumerated Values: Y = yes N = no" },
  ...
  { "ContrastFlowDurations",
    ...
    VR::DS,
    VM::VM1_n,
    "Duration(s) of injection(s) in seconds. Each Contrast Flow Duration value shall correspond to a value of Contrast "
    "Flow Rate (0018,1046)" },
  { "Contrast/Bolus Ingredient",
    "3",
    VR::CS,
    VM::VM1,
    "Active ingredient of agent, Defined Terms: IODINE, GADOLIMIUM, CARBON DIOXIDE, BARIUM" },
  ...
  { "PixelAspectRatio",
    ...
    VR::IS,
    VM::VM2,
    "Ratio of the vertical size and horizontal size of the pixels in the image specified by a pair of integer values "
    "where the first value is the vertical pixel size, and the second value is the horizontal pixel size. Required if "
    "the aspect ratio is not 1/1 and the Image Plane Module is not applicable to this Image" },
  //{"BitsAllocated","1",VR::US,VM::VM1,"Number of bits allocated for each pixel sample. Each sample shall have the same
  ...
  { "ImagePositionPatient",
    ...
    VR::DS,
    VM::VM3,
    "The x,y and z coordinates of the upper left and hand corner (first pixel transmitted) of the image, in mm" },
  ...
  { "WindowCenterWidthExplanation",
    ...
    VR::LO,
    VM::VM1_n,
    "Free form explanation of the meaning of the Window Center and Width. Multiple values correspond to multiple "
  ...
  { "DeviceSerialNumber",
    ...
    VR::LO,
    VM::VM1,
    "Manufacturer's seriel number of the equipment that produced the digital images" },
  { "SoftwareVersions",
    "3",
    VR::LO,
    VM::VM1_n,
    "Manufacturer's designation of software of the equipment that produced the digital images" },
  ...
  { "Overlay Origin",
    ...
    VR::US,
    VM::VM1,
    "Location of first overlay point with respect to pixel in the image, given as row/column" },
  ...
  { "ICE_Dims",
    ...
    VR::LO,
    VM::VM1,
    "The 9 used ICE object dimensions of the performed acquisition. Combined/unset dimensions will be marked with 'X'. "
    "E.g.: X_2_1_1_1_1_2_1_1" },
  ...
  { "RealDwellTime",
    ...
    VR::IS,
    VM::VM1,
    "The time in ns between the beginning of sampling one data point and the beginning of sampling of next data point "
    "in the acquired signal. This means the dwell time is the sampling rate during digital conversion of an acquired "
    "signal" },
  ...
  { "NonimageType",
    ...
    VR::CS,
    VM::VM1,
    "Data identification characteristics. Defined terms: RAW DATA NUM 4; SPEC NUM4" },
  ...
  //{"AcquisitionNumber","2",VR::IS,VM::VM1,"A number identifying the gathering of data over a period of time which
  //resulted in this data set"},
  ...
  { "ReferencedImageSequence",
    ...
    VR::UI,
    VM::VM1_n,
    "A sequence which provides reference to a set of Image SOP Class/Instance identifying other images significantly "
    "related to this image (localizer images)" },
  //{"PatientOrientation","1",VR::CS,VM::VM1,"Patient direction of the rows and columns of the image. Not required for
  //MR images"},
  { "ScanningSequence",
    "1",
    VR::CS,
  ...
  //{"RepetitionTime","1",VR::DS,VM::VM1,"The period of time in msec between the beginning of a pulse sequence and the
  //beginning of a succeeding (essentially identical) pulse sequence. Required except when Scanning Sequence is EP and
  //Sequnece Variant is not segmented k-space"},
  //{"EchoTime","1",VR::DS,VM::VM1,"Time in msec between the middle of the excitation pulse and the peak of the echo
  //produced. In the case of segmented k-space, the TE(eff) is the time between the middle of the excitation pulse to
  //the peak of the echo that is used to cover the center of k-space)"},
  //{"InversionTime","1",VR::DS,VM::VM1,"Time in msec after the middle of inverting RF pulse to middle of excitation
  //pulse to detect the amount of longitudinal magnetization. Required if Scanning Sequence has value of IR"},
  ...
  //{"EchoNumbers","1",VR::IS,VM::VM1,"The echo number used in generating this image. In the case of segmented k-space,
  //it is the effective Echo Number"},
  //{"MagneticFieldStrength","1",VR::DS,VM::VM1,"Nominal Field strength of MR magnet, in Tesla"},
  //{"NumberOfPhaseEncodingSteps","1",VR::IS,VM::VM1,"Total number of lines in k-space in the y-direction collecting
  //during acquisition"},
  ...
  //{"PercentPhaseFieldOfView","1",VR::DS,VM::VM1,"Ration of field of view dimension in phase direction to field of view
  //dimension in frequency direction, expressed as a percent"},
  //{"TriggerTime","1",VR::DS,VM::VM1,"Time, in msec, between peak of the R wave and the peak of the echo produced. In
  //the case of segmented k-space, the TE(eff) is the time between the peak of the echo that is used to cover the center
  //of k-space. Required for Scan Options which include heart gating"},
  { "ReceivingCoil", "1", VR::SH, VM::VM1, "Received coil used" },
  { "TransmittingColi", "1", VR::SH, VM::VM1, "Transmitted coil used" },
  //{"AcquisitionMatrixText","1",VR::US,VM::VM4,"Dimension of acquired frequency/phase data before reconstruction.
  //Multi-valued: frequency rows/frequency columns/phase rows/phase columns"},
  //{"PhaseEncodingDirection","1",VR::CS,VM::VM1,"The axis of phase encoding with respect to the image. Enumerated
  //Values: ROW = phase encoded in rows COL = phase encoded in columns"},
  //{"FlipAngle","1",VR::DS,VM::VM1,"Steady state angle in degrees to which the magnetic vector is flipped from the
  //magnetic vector to the primary field"},
  //{"VariableFlipAngleFlag","1",VR::CS,VM::VM1,"Flip angle variation applied during image acquisition. Enumerated
  //Values: Y = yes N = no"},
  ...
  //{"ImagePositionPatient","1",VR::DS,VM::VM3,"The direction cosines of the first row and the first column with respect
  //to the patient"},
  //{"ImageOrientationPatient","1",VR::DS,VM::VM6,"The x,y and z coordinates of the upper left and hand corner (first
  //pixel transmitted) of the image, in mm."},
  ...
  //{"EchoPartitionPosition","1",VR::IS,VM::VM1,"Echo partition position for the performed acquisition"},
  //{"Actual3DImaPartNumber","1",VR::IS,VM::VM1,"Number of a 3D partitions beginning with 0"},
  //{"RealDwellTime","1",VR::IS,VM::VM1,"The time in ns between the beginning of sampling one data point and the
  //beginning of sampling of next data point in the acquired signal. This means the dwell time is the sampling rate
  //during digital conversion of an acquired signal"},
  ...
  //{"ICE_Dims","1",VR::DS,VM::VM1,"The 9 used ICE object dimensions of the performed acquisition. Combined/unset
  //dimensions will be marked with 'X'. E.g.: X_2_1_1_1_1_2_1_1"},
  //{"PixelSpacing","1",VR::DS,VM::VM2,"Physical distance in the patient between the center of each pixel, specified by
  //a numeric pair-adjacent row spacing (delimiter) adjacent column spacing in mm"},
  { "SourceImageSequence",
    "1",
    VR::UI,
    VM::VM1_n,
    "A sequence which identifies the set of Image SOP Class/Instance pairs of the images which were use to derive this "
    "image" },
  //{"PixelBandwidth","1",VR::DS,VM::VM1,"Reciprocal of the total sampling period, in hertz per pixel"},
  //{"SliceMeasurementDuration","1",VR::DS,VM::VM1,"Time duration between two slices of the performed acquisition"},
  //{"SequenceMask","1",VR::UL,VM::VM1,"Parameters used for acquisition, e.g. door open, interpolation, raw filter,
  //Siemens seqence .·"},
  //{"AcquisitionMatrixText","1",VR::SH,VM::VM1,"Used acquisition matrix description"},
  //{"MeasuredFourierLines","1",VR::IS,VM::VM1,"Number of performed fourier lines"},
  ...
  { "sTXSPEC.asNucleusInfo[0].flAmplitudeCorrection",
    "3",
    VR::FD,
    VM::VM1,
  ...
  { "sKSpace.ucSlicePartialFourier",
    ...
    VR::US,
    VM::VM1,
    "Partial Fourier Information 0x1,0x2,0x4,0x8,0x10 resp. 4/8,5/8,6/8,7/8,8/8" },
  ...
  */
  ...
  { nullptr, nullptr, VR::INVALID, VM::VM0, nullptr }
};

void
CSAHeaderDict::LoadDefault()
{
  unsigned int   i = 0;
...
#endif // MDCMCSAHEADERDEFAULTDICT_CXX
