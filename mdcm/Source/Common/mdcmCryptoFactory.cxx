...
CryptoFactory *
CryptoFactory::GetFactoryInstance(CryptoFactory::CryptoLib id)
{
#ifdef _WIN32
...
std::map<CryptoFactory::CryptoLib, CryptoFactory *> &
CryptoFactory::getInstanceMap()
{
...
void
CryptoFactory::AddLib(CryptoFactory::CryptoLib id, CryptoFactory * f)
{
