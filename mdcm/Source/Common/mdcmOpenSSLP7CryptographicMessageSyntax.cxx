...
bool OpenSSLP7CryptographicMessageSyntax::Encrypt(
...
*/
bool OpenSSLP7CryptographicMessageSyntax::Decrypt(
  char * output, size_t & outlen, const char * array, size_t len) const
{
#ifdef MDCM_USE_SYSTEM_OPENSSL
...
#undef PKCS7_SIGNER_INFO
  ...
  if(!data) goto err;
  if (pp == NULL) BIO_set_fp(data, stdin, BIO_NOCLOSE);
...
//  }
  ...
  else
  {
    ...
    for (i = 0; i < sk_PKCS7_SIGNER_INFO_num(sk); ++i)
    {
      ...
      if (i <= 0) goto err;
      else fprintf(stderr, "Signature verified\n");
    }
  }
...
bool OpenSSLP7CryptographicMessageSyntax::SetPassword(const char *, size_t) override
{
